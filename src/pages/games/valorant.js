...
let clients = [
  {
    link: "https://lavicheats.com/valorant-hacks-cheats-aimbot/",
    game: "valorant",
    src: "lavi.png",
    name: "Lavi Cheats",
    desc: "Our Valorant hacks allow you to gain a competitive edge in matches, without having to risk your account, and reputation.",
    colour_a: "yellow",
    dot_a: "dot",
    tag_a: "ESP",
    colour_b: "red",
...
function App() {
  ...
  const data = {
    ...
    link: "Valorant",
    src: "Valorant.png",
    desc: "Valorant is a free-to-play first-person hero shooter developed and published by Riot Games, for Microsoft Windows.",
  };
